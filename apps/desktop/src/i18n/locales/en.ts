...
export const en = {
  ...
  "settings.toast.omarchyContextSaved": "Omarchy companion setting saved.",
  ...
  "settings.omarchyFullscreen.label": "Hide the default pet in fullscreen",
  "settings.omarchyFullscreen.description": "Temporarily hides the default pet when the focused Omarchy workspace is fullscreen without changing your visibility preference.",
  "settings.omarchyMonitor.label": "Follow the active Omarchy monitor",
  "settings.omarchyMonitor.description": "Moves the default pet to the focused monitor and restores its last position there.",
  ...
  "integrations.environment.name.omarchy": "Omarchy Environment",
  "integrations.environment.name.linux": "Linux Environment",
  "integrations.environment.omarchy": "Omarchy {version}",
  "integrations.environment.linux": "Linux",
  "integrations.environment.desktop": "Linux desktop",
  "integrations.environment.unknown": "Unknown backend",
  "integrations.environment.ready": "Ready",
  "integrations.environment.attention": "Needs attention",
  "integrations.environment.positioning.hyprland": "Window positioning uses trusted Hyprland IPC.",
  "integrations.environment.positioning.electron": "Window positioning uses Electron.",
  "integrations.environment.positioning.unsupported": "Autonomous window positioning is unavailable on this native Wayland compositor.",
  "integrations.environment.manage": "Manage Integration",
  "integrations.environment.setup": "Omarchy",
  "integrations.environment.managedSetup": "Managed Setup",
  "integrations.environment.artifacts": "Configuration",
  "integrations.environment.files": "Managed Artifacts",
  "integrations.environment.hyprlandRules": "Hyprland rules",
  "integrations.environment.hyprlandSource": "Hyprland source directive",
  "integrations.environment.autostart": "UWSM autostart",
  "integrations.environment.waybarConfig": "Waybar module",
  "integrations.environment.waybarHelper": "Waybar status helper",
  "integrations.environment.walkerMenu": "Walker controls menu",
  "integrations.environment.repair": "Repair",
  "integrations.environment.remove": "Remove",
  "integrations.environment.doctor": "Run Doctor",
  "integrations.environment.repairing": "Repairing",
  "integrations.environment.doctoring": "Checking",
  "integrations.environment.setupState.unsupported": "Unsupported",
  "integrations.environment.setupState.not_installed": "Not installed",
  "integrations.environment.setupState.installed": "Installed",
  "integrations.environment.setupState.needs_repair": "Needs repair",
  "integrations.environment.setupState.conflict": "Conflict",
  "integrations.environment.setupState.error": "Error",
  "integrations.environment.artifactState.missing": "Missing",
  "integrations.environment.artifactState.installed": "Installed",
  "integrations.environment.artifactState.needs_repair": "Needs repair",
  "integrations.environment.artifactState.conflict": "Conflict",
  "integrations.environment.artifactState.error": "Error",
